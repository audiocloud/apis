...
use crate::{AppTaskId, DestinationPadId, DynamicInstanceNodeId, PadMetering, SourcePadId};
...
pub enum EngineEvent {
    ...
    Playing {
        ...
        output_peak_meters: HashMap<SourcePadId, PadMetering>,
        /// Peak meters for each destination pad
        input_peak_meters:  HashMap<DestinationPadId, PadMetering>,
